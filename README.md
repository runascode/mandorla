...
| **Experiment 06 — Substrate pilot** ([`experiments/06-substrate-pilot/`](./experiments/06-substrate-pilot/PILOT-DESIGN.md)) | 🔲 **Pre-PRECOMMIT design** (2026-05-28). Tests the surviving "architecture must be intersection-native" rescue at cheapest-to-screen scale: full 2³ factorial over input × representation × objective primitives, capacity-matched. Stage A (thesis-independent lit survey, [`findings/substrate-rethinks-survey.md`](./findings/substrate-rethinks-survey.md)) must complete before B's PRECOMMIT can be locked. |
